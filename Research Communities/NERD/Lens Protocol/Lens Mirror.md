...
[Suggest Edits](/edit/mirror)

![](https://files.readme.io/a0d0026-mirror.svg)

Mirrors are the curation tool of the Lens Protocol. They are the protocol's equivalent to reposting or re-amplifying content. Mirrors are treated the same as [publications](/docs/publication) with a few additional checks and a few more minor features.
