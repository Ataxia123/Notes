...
[Suggest Edits](/edit/profile)

![](https://files.readme.io/471e0ba-profile.svg)

The Profile NFT is the main object in the Lens Protocol. It is ownership over this NFT that gives you control of your content. Individual addresses own ProfileNFTs, and an address can contain multiple ProfileNFTs. What differentiates the Lens Profile NFT from other on-chain identities is the ability to post [Publications](/docs/publication) to it. The Profile NFT contains the history of all of the posts, [mirrors](/docs/mirror), [comments](/docs/comment), and other content you generate.

Additionally, Profile NFTs contain a [FollowModule](/docs/follow). This module contains the logic that allows different accounts to be issued Follow NFTs to record their relationship to the main profile on-chain.
