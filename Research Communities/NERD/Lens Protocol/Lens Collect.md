...
[Suggest Edits](/edit/collect)

![](https://files.readme.io/ada0647-collect.svg)
...
When a user posts a [publication](/docs/publication) to their [Profile NFT](/docs/profile) they have the option to set a Collect Module. This module will allow other users to mint NFTs that link to the publication's ContentURI. This module can contain any arbitrary logic to apply to the minting process and the resulting NFT.
